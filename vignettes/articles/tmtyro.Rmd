...
![Graphic comparing four tools by their accessibility to beginners. Voyant is shown as the one most accessible to beginners, followed in order by tmtyro, tidytext, and tm. Voyant is colored purple to indicate its use of a graphical interface. The other tools are colored pink to indicate their use of a coding interface.](skill_speedometer.png)
