...
As of v0.6, tmtyro offers `theme_tmtyro()` to set a theme and turn off unnecessary grid lines. These theme elements can also be adjusted with existing ggplot2 methods.
