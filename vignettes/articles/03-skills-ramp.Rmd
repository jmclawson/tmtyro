...
tmtyro is optimized for a fast start, speeding users along a standard workflow made possible by tidytext and the tidyverse packages on which it's built. It also offers a pathway for growth by providing vectorized functions for use in a larger ecosystem of tools and simplifying the transition to text mining for anyone familiar with those tools.
...
corpus_dubliners |> 
  mutate(
    sent_1 = get_match(word, textdata::lexicon_bing()),
