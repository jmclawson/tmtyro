...
[`tabulize()`](https://jmclawson.github.io/tmtyro/reference/tabulize.md)
(and gt in general) are center aligned. To adjust this alignment, use
gt’s [`cols_align()`](https://gt.rstudio.com/reference/cols_align.html)
function.
...
corpus_dubliners |> 
  tabulize() |> 
  gt_theme_538()
#> Table has no assigned ID, using random ID 'kgufivjubq' to apply `gt::opt_css()`
